...
const ExtendTimeMenu = ({ items, setModalOpen, setDataForModal }) => {
        ...
        return (
          ...
          <article style={{marginLeft:'-5rem', cursor:"revert"}} key={id} className="menu-item">
            ...
            <div style={{width:'30rem'}} className="item-info">
              ...
              <button onClick={()=>{setDone([...done, item.id]);}} className="inside-menu-button" style={{border:'2px solid #FF0000', background:'rgba(255, 0, 0, .04)'}}>Reject</button>
