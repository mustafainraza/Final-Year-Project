...
router.get(
  ...
  indexcontroller.campaigner_changepassword
);
router.post(
  "/change-password/:id/:token",
  indexcontroller.campaigner_submitchangepassword
);
...
router.get(
  ...
  auth,
  indexcontroller.get_campaign_details
);
...
router.get(
  "/campaignextensionrequest/:id",
  auth,
  indexcontroller.campaign_extension_request
);
