        ...
        <View style={styles.container}>
            ...
            >
                <Faqs title={"How do I start a project?"}>
                    ...
                    >
                        <Text style={{ fontSize: 14, color: "white" }}>
                            ...
                            on PJD Crowd-Funding Application...
                        </Text>
                    </View>
                </Faqs>
                ...
                <Faqs title={"How do I pledge?"}>
                    ...
                    >
                        <Text style={{ fontSize: 14, color: "white" }}>
                            ...
                            Before we start, make sure that you’re logged in to PJD
                ...
                <Faqs title={"How can I find interesting projects to back?"}>
                    ...
                    >
                        <Text style={{ fontSize: 14, color: "white" }}>
                            ...
                            favorite PJD Crowd-Funding creators to see what projects they
                ...
                <Faqs title={"What’s my profile page, and what appears?"}>
                    ...
                    >
                        <Text style={{ fontSize: 14, color: "white" }}>
                            When you create a PJD Crowd-Funding account, a basic profile page
                            is created for you. It displays your chosen account name, the date
                            the account was created, a list of projects you have backed or
                            launched, and whether you are a backer.
                        </Text>
                    </View>
                </Faqs>
                ...
                <Faqs title={"Projects must create something to share?"}>
                    ...
                    >
                        <Text style={{ fontSize: 14, color: "white" }}>
                            PJD Crowd-Funding can be used to create all sorts of things: art
                            and gadgets, events and spaces, ideas and experiences.
                        </Text>
                    </View>
                </Faqs>
                ...
                <Faqs title={"The reward I received is not what I expected"}>
                    ...
                    >
                        <Text style={{ fontSize: 14, color: "white" }}>
                            PJD Crowd-Funding is a place for creators to bring their creative
                            ideas to life, and we do our best to give them the support and
                            freedom necessary to do so. We expect creators to make every
                            effort to complete their project as promised
                        </Text>
                    </View>
                </Faqs>
