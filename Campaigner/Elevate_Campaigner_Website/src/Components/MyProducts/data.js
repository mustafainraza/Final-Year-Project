const menu = [
  ...
  },
  {
    ...
    desc: `ContactGlove is a revolutionary VR controller in the form of a glove, equipped with haptic feedback and high-precision hand tracking. With button input just like conventional VR controllers, ContactGlove allows you to experience a truly immersive VR world. Plus, its compatible with all SteamVR content! 
    Until now, VR gloves were only accessible to a select few due to their high cost and proprietary software requirements. Weve changed that by making our VR glove controller compatible with Steam VR, the most popular VR content platform, making it accessible to a wider audience. Now, everyone can enjoy the benefits of a VR glove controller at a more affordable price.`,
    progress: 50,
    hoursLeft: 83,
  },
  {
    ...
    This isnt our first campaign and thats why we know to expect the unexpected. To set things off on the right foot, weve been in constant communication with our manufacturer and have built a great relationship with them with super clear and honest communications between us. We also have established a great relationship with our 3PL that will deliver your rewards. Since weve not only done a Kickstarter campaign before, but also consistent retail and ecommerce sales (thanks to all of you!), we feel confident in our ability to deliver your rewards, safely and on time. 
    Clear communication is what we stand for. So you can expect that along the entire way we will be clear, honest and prepared for anything. If there are any hiccups along the way, youll be the first to know. `,
    progress: 27,
    hoursLeft: 218,
  },
  {
  ...
  },
  {
    ...
    Its an 8-bit video game console on a tiny circuit board! The Arduboy Mini includes over 300 games but shrinks the size. Without a case or battery (speaker now included!) of the full size Arduboy FX, the Mini is a cute-as-heck piece of functional circuit board art. And yes, that’s a USB-C port! Choose between a flat colorway or the Graffiti Edition, featuring custom silkscreen tags of developer names from the Arduboy community! `,
    progress: 66,
    hoursLeft: 68,
  },
  {
  ...
  {
    id: 7,
    title: `Navigators Loupe by Oceanus Brass`,
    category: "reward based",
    like: 8,
    ...
    A 1.8” aperture provides the concentrating power for emergency situations or to leave a mark, not soon forgotten. Whether youre a sailor, an outdoorsman, or someone who appreciates quality, we believe youll love the Navigator’s Loupe as much as we do. 
    The Navigators Loupe has been manufactured to thrive over decades of use, through all of the conditions you intend to throw it through. What was once a labor of love, is now a timeless recycling instrument available for all, but we need your help to make this dream a reality.`,
    progress: 100,
    hoursLeft: 4,
  },
  {
  ...
  },
  {
    ...
    The price of one WONDER FITTER kit is only equal to the cost of five trips to the backyard training range, or 11.5 hours of membership training, or three hours of professional archery lessons. Dont forget about the real bow and arrow that come with the set and the free access to the APP. Youll have everything you need for a lifetime of fun with this great hobby without breaking your budget. 
    WONDER FITTER is the easiest, fastest, and most practical way to practice archery whenever you want! Youll never be limited by inclement weather, municipal restrictions, cost, or a local professional range thats booked up. Whenever you feel like a shooting fix, you can just grab your bow and arrows and hit the bullseye with WONDER FITTER!`,
    progress: 50,
    hoursLeft: 167,
  },
  {
